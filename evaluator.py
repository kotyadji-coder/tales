...
FORBIDDEN_PATTERNS = [
    r"\bубил\b", r"\bубить\b", r"\bсмерть\b", r"\bмёртв", r"\bмертв", r"\bтруп\b", r"\bгроб\b", r"\bпохорон",
    r"\bкровь\b", r"\bкровав", r"\bкровоточ",
    r"\bоружи", r"\bпистолет", r"\bружь",
    r"\bсекс", r"\bпорно", r"\bнаркотик", r"\bалкоголь\b", r"\bводк[аиу]",
]
